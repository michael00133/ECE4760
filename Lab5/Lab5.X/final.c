...
void main(void) {
	...
	#define PARAM4	ENABLE_AN11_ANA | ENABLE_AN12_ANA// pin 24
	...
	SetChanADC10( ADC_CH0_NEG_SAMPLEA_NVREF | ADC_CH0_POS_SAMPLEA_AN11 | ADC_CH0_NEG_SAMPLEB_NVREF | ADC_CH0_POS_SAMPLEB_AN12  ); // configure to sample AN4 
